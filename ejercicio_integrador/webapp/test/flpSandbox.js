		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Integrador",
									"targetURL": "#comproyejerciciointegrador-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comproyejerciciointegrador-display": {
								"semanticObject": "comproyejerciciointegrador",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.proy.ejerciciointegrador",
									"url": sap.ui.require.toUrl("com/proy/ejerciciointegrador")
								}
							}
						}
					}
